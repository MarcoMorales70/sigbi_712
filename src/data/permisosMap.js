export const permisosMap = {  // Exportar la constante para que pueda ser consumida.
    ...
    //8: { modulo: "Control", seccion: "Técnicos", titulo: "Modificar Permisos" }, // Se coloco de manera implícita en su módulo, si se ejecuta.
    9: { modulo: "Control", seccion: "Técnicos", titulo: "Eliminar Técnicos" },
    10: { modulo: "Control", seccion: null, titulo: "Generar Códigos" },
    //11: { modulo: "Control", seccion: null, titulo: "Ingresar a Módulos" }, // Se colocó de manera implícita en su módulo, si se ejecuta.
    ...
    25: { modulo: "Hardware", seccion: "Bajas", titulo: "Reactivar Bienes" },
    ...
    42: { modulo: "Software", seccion: null, titulo: "Asignar Servicios" },
    43: { modulo: "Software", seccion: null, titulo: "Registrar Configuraciones" },
    44: { modulo: "Software", seccion: null, titulo: "Asignar Configuraciones" },
    ...
    47: { modulo: "Reportes", seccion: null, titulo: "Visualizar Indicadores" },
    48: { modulo: "Reportes", seccion: null, titulo: "Consultar Bitácora" },

};

//console.log("permisosMap:", permisosMap); // Mensaje de apoyo